...
public class shootGun : MonoBehaviour
{
	...
	{
		if (Input.GetKeyDown(KeyCode.JoystickButton4) && !((FirstPersonController_Egen)player.GetComponent(typeof(FirstPersonController_Egen))).menuEnabled && ((PickUp)ammoCheckHolder.GetComponent(typeof(PickUp))).oldShotgunLoaded)
		{
			shooting = true;
		}
