...
public class ShootArrow : MonoBehaviour
{
	...
	{
		if (Input.GetKeyDown(KeyCode.JoystickButton2) && !((FirstPersonController_Egen)player.GetComponent(typeof(FirstPersonController_Egen))).menuEnabled && laddad.activeSelf)
		{
			shooting = true;
		}
