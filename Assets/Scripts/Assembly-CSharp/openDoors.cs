...
public class openDoors : MonoBehaviour
{
	...
	{
		if (Input.GetKeyDown(KeyCode.JoystickButton0) && !((FirstPersonController_Egen)player.GetComponent(typeof(FirstPersonController_Egen))).menuEnabled && (bool)openDoorButton)
		{
			openTheDoor = true;
			playSound = false;
		}
		...
		if (!playerTaken)
		{
			if (Physics.Raycast(doorRay.transform.position, direction, out hitInfo, 4f, layerMask))
			{
				if (hitInfo.collider.gameObject.tag == "innerdoorClosed")
				{
					...
					if (openTheDoor)
					{
						hitInfo.collider.gameObject.GetComponent<Animation>().Play("InnerdoorOpen_3");
						hitInfo.collider.gameObject.GetComponent<Animation>().Play("InnerdoorOpen_2");
						hitInfo.collider.gameObject.GetComponent<Animation>().Play("InnerdoorOpen_1");
						hitInfo.collider.gameObject.GetComponent<Animation>().Play("InnerdoorOpen_0");
				...
				else if (hitInfo.collider.gameObject.tag == "innerdoorOpen")
				{
					...
					if (openTheDoor)
					{
						hitInfo.collider.gameObject.GetComponent<Animation>().Play("InnerdoorClose_3");
						hitInfo.collider.gameObject.GetComponent<Animation>().Play("InnerdoorClose_2");
						hitInfo.collider.gameObject.GetComponent<Animation>().Play("InnerdoorClose_1");
						hitInfo.collider.gameObject.GetComponent<Animation>().Play("InnerdoorClose_0");
				...
				else if (hitInfo.collider.gameObject.tag == "innerdoorLocked")
				{
					...
					{
						playSound = true;
						hitInfo.collider.gameObject.GetComponent<Animation>().Play("InnerdoorLocked_2");
						hitInfo.collider.gameObject.GetComponent<Animation>().Play("InnerdoorLocked_1");
						hitInfo.collider.gameObject.GetComponent<Animation>().Play("InnerdoorLocked_0");
						hitInfo.collider.gameObject.GetComponent<Animation>().Play("InnerdoorClose");
					}
				}
				...
				else if (hitInfo.collider.gameObject.tag == "garde1Closed")
				{
					...
					if (openTheDoor)
					{
						hitInfo.collider.gameObject.GetComponent<Animation>().Play("Garde1Open_1");
				...
				else if (hitInfo.collider.gameObject.tag == "garde1Open")
				{
					...
					if (openTheDoor)
					{
						hitInfo.collider.gameObject.GetComponent<Animation>().Play("Garde1Close_1");
