...
public class pickupFlashlight : MonoBehaviour
{
	...
	private void Update()
	{
		if (Input.GetKeyDown(KeyCode.JoystickButton0) && !((FirstPersonController_Egen)player.GetComponent(typeof(FirstPersonController_Egen))).menuEnabled && (bool)flashlightEtext)
		{
