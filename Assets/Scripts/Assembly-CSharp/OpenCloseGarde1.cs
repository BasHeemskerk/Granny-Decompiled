...
public class OpenCloseGarde1 : MonoBehaviour
{
	...
	{
		if (!DoorOpen && GetComponent<Animation>().IsPlaying("Garde1Open_0") || !DoorOpen && GetComponent<Animation>().IsPlaying("Garde1Open"))
		{
		...
		if (DoorOpen && GetComponent<Animation>().IsPlaying("Garde1Close_0") || DoorOpen && GetComponent<Animation>().IsPlaying("Garde1Close"))
		{
